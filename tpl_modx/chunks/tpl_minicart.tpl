    ...
    <div class="empty h-100">
        <a href="{$_modx->makeUrl(10)}"
           ...
           type="submit">
            ...
            <span class="badge badge-danger text-white p-1 ms2_total_count position-absolute fonts-size-10">0</span>
        </a>
    </div>
    <div class="not_empty h-100">
        <a href="{$_modx->makeUrl(10)}"
           class="btn btn-group__cart btn-outline-dark position-relative border-0 border-r0 my-2 my-sm-0 py-3 px-5 h-100"
            ...
            <span class="badge badge-danger  text-white p-1 ms2_total_count position-absolute fonts-size-10">{$total_count}</span>
        </a>
    </div>
</div>