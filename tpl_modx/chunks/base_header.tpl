            ...
            <li class="nav-item">
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button class="btn btn-warning btn-group_price py-2" data-toggle="modal" data-target="#modalPrice">
                        <a href="[[++price_file]]" download="download" class="text-decoration-none text-reset">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                ...
                <div class="col-auto d-flex flex-column align-items-center d-md-none px-0">
                    ...
                    <div class="media align-items-center mt-4">
                        <div class="media-body media-body__contact ml-3">
                            {if '+phone1' | placeholder }
                            <h5 class="m-0 font-weight-bold fonts-size-14">+{'+phone1' | placeholder}</h5>
                            <a href="tel:{'+phone1' | placeholder}" class="text-dark fonts-size-12">
                                <i class="fab fa-whatsapp text-success"></i>
                                Написать в WhatsUp
                            </a>
                            {/if}
