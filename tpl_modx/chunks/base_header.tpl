<header class="header">
    <div class="navbar navbar-expand-lg navbar-light navbar-top bg-white d-md-none fixed-top" style="z-index:1051">
        <div class="container-fluid container-xl">
            <div class="row row-cols-2 justify-content-md-between align-items-center w-100">
                <div class="col-10 col-sm-5 col-md-auto brand d-flex align-items-center">
                    ...
                    <div class="fonts-size-14 m-0">Завод бетонных изделий</div>
                </div>
                <!-- Button trigger modal feedback whatsup-->
                <div class="col-1 media position-relative phone-btn">
                    <img src="/assets/templates/nova-st/img/phone.png" class="ml-3 d-sm-none " alt="phone" title="compani phone">

                      <div class="media-body  d-none" style="left:100px">
                        <a href="tel:+{'+phone1' | placeholder}" class="" ></a>
                      </div>
                </div>
               
                <div class="col-auto d-none d-sm-flex align-items-center pr-0">
                    <div class="media align-items-center d-none d-md-flex">
                        <h4 class="fas fa-map-marker-alt m-0 text-muted"></h4>
                        <div class="media-body media-body__address">
                            {if '+address' | placeholder }
                                <h6 class="mt-0">{'+address' | placeholder}</h6>
                            {/if}
                    ...
                    <div class="media align-items-center">
                        <div class="media-body media-body__contact">
                            {if '+phone1' | placeholder }
                            <a href="tel:+{'+phone1' | placeholder}"  class="h5 text-dark font-weight-bold">
                            +{'+phone1' | placeholder}
                            </a>
                            <br>
    ...
    <div class="navbar navbar-expand-lg navbar-light navbar-top bg-white d-none d-md-flex">
        <div class="container-fluid container-xl">
            <div class="row row-cols-2 justify-content-sm-center justify-content-md-between align-items-center w-100">
                ...
                <!-- Button trigger modal feedback whatsup-->
                <a href="tel:+{'+phone1' | placeholder}" class="col-1 d-sm-none" terget="_blank">
                    <img src="/assets/templates/nova-st/img/phone.png" alt="phone" title="compani phone">
                </a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-bottom bg-white py-0 border-top border-bottom  mt-5 pt-4 mt-md-0 pt-md-0">
        ...
        <ul class="nav justify-content-end d-lg-none">
            <li class="nav-item">
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{$_modx->makeUrl(10)}" class="btn btn-group__cart btn-outline-dark border-0 focus-none py-2">
                        <i class="cart-icon"></i>
                    </a>
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                    ...
                    <li class="nav-item">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <button class="btn btn-warning btn-group_price my-2 my-sm-0 py-3 px-4" data-toggle="modal"
                                ...
                                <span class="ml-2">Скачать прайс-лист</span>
                                </a>
                            </button>
                ...
                <div class="col-auto d-flex flex-column align-items-center d-md-none px-0">
                    <div class="media align-items-center mt-4">
                        ...
                        <div class="media-body media-body__address ml-3">
                            {if '+address' | placeholder }
                            <h6 class="mt-0 fonts-size-10">{'+address' | placeholder}</h6>
                            {/if}
                            {if '+working_day' | placeholder}
                            <p class="text-muted m-0 fonts-size-10">{'+working_day' | placeholder}</p>
                            {/if}
                        </div>
                    </div>
                    <div class="media align-items-center mt-4">
                        <div class="media-body media-body__contact ml-3">
                            {if '+phone1' | placeholder }
                            <a href="tel:+{'+phone1' | placeholder}" class="col-1 font-weight-bold text-dark">
                               +{'+phone1' | placeholder}
                            </a>
                            {/if}
                        </div>
                    ...
                    <div class="media align-items-center mt-4">
                        <div class="media-body media-body__contact ml-3">
                            {if '+phone1' | placeholder }
                            <a href="https://wa.me/{'+whatsup' | placeholder}?text=Здравствуйте.%20Вопрос%20по%20поводу%20плитки." class="text-dark fonts-size-12">
                                <i class="fab fa-whatsapp text-success"></i>
                                Написать в WhatsUp
                            </a>
                            {/if}
                        ...
                        {if '+vk' | placeholder}
                            <li>
                                <a href="{'+vk' | placeholder}">
                                    <img src="assets/templates/nova-st/img/footer/vk .png" height="26" width="25" alt="vk" title="vk"/>
                                </a></li>
                        {/if}
                        {if '+instagram' | placeholder}
                            <li>
                                <a href="{'+instagram' | placeholder}">
                                    <img src="assets/templates/nova-st/img/footer/instagram.png" height="26" width="25" alt="instagram" title="vinstagram"/>
                                </a>
                            </li>
                        {/if}
                        {if '+facebook' | placeholder}
                            <li>
                                <a href="{'+facebook' | placeholder}">
                                    <img src="assets/templates/nova-st/img/footer/facebook.png" height="26" width="25" alt="facebook" title="facebook"/>
                                </a>
                            </li>
                        {/if}
                    </ul>
