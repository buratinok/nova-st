<div class="msearch2 container-fluid container-xl" id="mse2_mfilter">
    ...
    <div class="container-fluid container-lg">
        ...
        <div class="row justify-content-between d-none d-md-flex">
            ...
            <div class="span3 col-auto align-self-center px-md-0 mb-3">
                <fieldset>
                    <select name="mse_limit" id="mse2_limit"
                            class="form-control select-appearance_none select_arrow px-4 fonts-size-14">
            ...
            <div class="col-2 align-self-center pr-0 mb-3">
                <h5 class="text-muted float-md-right">Сортировать:</h5>
            </div>
            ...
            <div class="col-auto align-self-center px-md-0 mb-3">
                <fieldset>
                    <select class="form-control sorting_cat select-appearance_none select_arrow px-2 fonts-size-14">
                        <option class="sort" data-sort="resource|pagetitle" value="asc" hidden disabled selected>По
                            названии
                        </option>
            ...
            <div class="col-2 align-self-center px-md-0 mb-3">
                <fieldset>
                    <select class="form-control sorting_cat select-appearance_none select_arrow px-2 fonts-size-14">
                        <option class="sort" data-sort="popular|pagetitle" value="asc" hidden disabled selected>По
                            популярности
                        </option>
    ...
    <div class="catalog-category__tab">
        <div class="row">
